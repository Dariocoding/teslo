...
const Modal: React.FC<IModalProps> = props => {
	...
	return ReactDOM.createPortal(
		<React.Fragment>
			<div className="justify-center items-center flex overflow-hidden fixed inset-0 z-[1000] outline-none focus:outline-none">
				<div
				...
				>
					<div className="border-0 rounded-lg shadow-lg flex flex-col max-h-[100vh] w-full bg-white outline-none focus:outline-none">
						...
						<div className="relative p-6 flex-auto text-lg">{props.children}</div>
					</div>
				</div>
			</div>
