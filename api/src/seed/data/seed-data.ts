...
export const initialData: SeedData = {
  users: [
    {
      ...
      roles: [ValidRoles.ADMIN, ValidRoles.SUPER_USER],
      wishlist: [],
      prefix: null,
      dni: null,
    },
  ...
  categories: [{ title: "T-Shirts" }, { title: "Boots" }, { title: "Pants" }, { title: "Skirts" }],

  brands: [{ title: "Nike" }, { title: "RSR24" }, { title: "Lions Roots" }, { title: "Macuto" }],
  ...
  orders: [
    {
      total: 100,
      detail: [{ total: 25, quantity: 4, size: ValidSizes.M }],
      reference: uuid(),
      status: ValidStatusOrder.CANCELED,
    },
    {
      total: 50,
      detail: [{ total: 25, quantity: 2, size: ValidSizes.XL }],
      reference: uuid().split("-")[0],
      status: ValidStatusOrder.COMPLETED,
    },
    {
      total: 75,
      detail: [{ total: 25, quantity: 3, size: ValidSizes.XS }],
      reference: uuid().split("-")[0],
      status: ValidStatusOrder.PENDING,
    },
    {
      total: 110,
      detail: [
        { total: 25, quantity: 4, size: ValidSizes.XXS },
        { total: 10, quantity: 1, size: ValidSizes.XXL },
      ],
      reference: uuid(),
      status: ValidStatusOrder.CANCELED,
    },
