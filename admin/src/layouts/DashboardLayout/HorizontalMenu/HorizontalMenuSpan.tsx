    ...
    <div className="flex items-center gap-1">
      <span
        className={classNames(
          "flex items-center cursor-pointer py-2 px-3 rounded-lg transition whitespace-nowrap",
      ...
      <RenderIf isTrue={!lastItem}>
        <span className="h-full dark:bg-gray-700 mx-1 w-px inline-block select-none font-thin">
          |
        </span>
      </RenderIf>
    </div>
