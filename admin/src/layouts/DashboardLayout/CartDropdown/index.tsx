				...
				<>
					<Popover.Button
						className={classNames(
							'group w-10 h-10 sm:w-12 sm:h-12 hover:bg-slate-10 rounded-full inline-flex items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 relative',
							open && 'text-opacity-90'
						)}
					>
						<RenderIf
							isTrue={totalProducts <= 99 && cart.length}
						>
