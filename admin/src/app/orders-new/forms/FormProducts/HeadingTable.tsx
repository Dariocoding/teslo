...
const HeadingTable = () => {
	...
	const isTempTable =
		refThead && document.getElementById("tableTempProduct")?.contains?.(refThead);
	const { colors } = useConfigApp();

	return (
		<thead
			className="bg-blue-600 bg-opacity-10 backdrop-filter backdrop-blur-lg"
			ref={setRefThead}
		>
			<tr>
				<th className="px-2 py-2 w-[130px] max-w-[130px]">
					{translate("products.label.code")}
				</th>
				...
				<th className="px-2 py-2 w-[115px] text-center">
