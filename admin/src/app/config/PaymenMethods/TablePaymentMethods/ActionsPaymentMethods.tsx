...
const ActionsPaymentMethods: React.FunctionComponent<IActionsPaymentMethodsProps> = (props) => {
  const { paymentMethod, deletePaymentMethod, updatePaymentMethod, setViewOrdersByPaymentMethod } =
    props;
  ...
  return (
    <div className="grid grid-cols-2 w-20 mx-auto lg:w-28">
      ...
      <button className="btn btn-danger btn-xs col-span-2" onClick={handleDeletePayment}>
        <FaTrash />
      </button>
    </div>
  );
