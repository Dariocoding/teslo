	...
	[
		...
		calcTotal
			? [
					...
					"",
					formatter.format(
						orders.reduce((prev: number, curr: Order) => prev + curr.total, 0)
					),
			  ]
			: null,
	].filter(o => o);
	...
	[
		...
		calcTotal
			? [
					...
					"",
					formatter.format(
						bills.reduce((prev: number, curr: Bill) => prev + curr.subtotal, 0)
					),
					formatter.format(
						bills.reduce((prev: number, curr: Bill) => prev + curr.total, 0)
					),
			  ]
			: null,
	].filter(b => b);
