			...
			<Form>
				<InputFormik
					...
					placeholder={translate(
						'settings.enterPriseData.placeholder.name'
					)}
				/>
				...
				<InputFormik
					...
					placeholder={translate(
						'settings.enterPriseData.placeholder.email'
					)}
				/>
				...
				<InputFormik
					...
					placeholder={translate(
						'settings.enterPriseData.placeholder.phone'
					)}
				/>
				...
				<TextareaFormik
					...
					placeholder={translate(
						'settings.enterPriseData.placeholder.address'
					)}
				/>
