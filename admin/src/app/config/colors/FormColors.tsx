		...
		<div>
			<div className="form-group">
				...
				<div className="grid lg:grid-cols-2 gap-x-4">
					...
					<InputColor name="topLogoContainer">
						Top logo container
					</InputColor>
				</div>
			</div>
			<div className="form-group">
				...
				<div className="grid lg:grid-cols-2 gap-x-4">
					<InputColor name="sidebarItemHover">
						Sidebar item hover
					</InputColor>
					<InputColor name="hoverNavToggle">
						Hover Nav Toggle
					</InputColor>
					<InputColor name="sidebarContainer">
						Sidebar container
					</InputColor>
					<InputColor name="sidebarDropdownCollapsedContainer">
						Sidebar dropdown collapsed container
					</InputColor>
					<InputColor name="sidebarItemDropdown">
						Sidebar item dropdown
					</InputColor>
					<InputColor name="textSubtitleSidebar">
			...
			<div>
				...
				<div className="grid lg:grid-cols-2 gap-x-4">
					...
					<InputColor name="backgroundHome">
						Background Home
					</InputColor>
