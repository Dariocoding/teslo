...
const useDefaultHeadingProducts = (propsHook: UseDefaultHeadingProducts): HeaderDataTable[] => {
	...
	const arr: HeaderDataTable[] = [
		...
		{ title: translate("products.label.price"), field: "priceFormatted", center: true },
		...
		{ title: translate("products.label.brand"), field: "brand.title", center: true },
		{ title: translate("products.label.providers"), field: "providersFormatted", center: true },
		{ title: translate("products.label.status"), field: "status", center: true },
		{ title: translate("products.label.actions"), field: "actions", center: true },
	];

	const arrClothesShopping = [
		{ title: translate("products.label.gender"), field: "gender", center: true },
		{ title: translate("products.label.sizes"), field: "sizesFormatted", center: true },
	];
