  ...
  return (
    <div className="lg:px-8">
      ...
      <div className="mt-4 flex items-center justify-center">
        <button type="button" className="btn btn-xs btn-alternative mb-0 gap-1" onClick={onCancel}>
          {translate("app.cancel")} <FaTimes />
        </button>
        <button type="button" className="btn btn-xs btn-primary mb-0 gap-1" onClick={onConfirm}>
