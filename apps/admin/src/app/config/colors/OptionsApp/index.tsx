  ...
  return (
    <div className="grid grid-cols-2">
      <div className={classNames("form-group mb-2")}>
        <Label className={""}>Enable Prefix User</Label>
        <Switch
          checked={colors.enablePrefixesUser}
          onChange={() => setColors({ ...colors, enablePrefixesUser: !colors.enablePrefixesUser })}
          className={`${
            colors.enablePrefixesUser ? "bg-blue-600" : "bg-gray-200"
          } relative inline-flex h-6 w-11 items-center rounded-full`}
        >
          <span
            className={`${
              colors.enablePrefixesUser ? "translate-x-6" : "translate-x-1"
