...
const MenuBar: React.FC<MenuBarProps> = () => {
	...
	return (
		<>
			...
			<RenderContent handleCloseMenu={handleCloseMenu} isVisible={isVisible} />
		</>
	);
};
...
const RenderContent: React.FunctionComponent<IRenderContentProps> = props => {
	const { isVisible, handleCloseMenu } = props;
	return (
